...
pop.addEventListener("click", () => {
  ...
  //start poping the element
  setTimeout(() => {
    bucket.removeChild(bucket.lastElementChild); //delete the element from the bucket
    const itemValue = stack.pop(); //Storing the poped value
    box[2].innerHTML = itemValue; //updating the last poped item
    ...
    //adding the massage
    massage.innerHTML = `Item ${itemValue} is Poped.`;
